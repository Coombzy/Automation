...
| `token_optimizer` | `autonomous-ai-agents/token_optimizer/SKILL.md` | 8006 | `6ef6c3ca828fc033` | eligible_full_copy |
| `token_preflight` | `autonomous-ai-agents/token_preflight/SKILL.md` | 2126 | `1ec7a7a29ae9cc76` | eligible_full_copy |
| `computer-use` | `computer-use/SKILL.md` | 11179 | `33fdce112f142cd3` | eligible_full_copy |
| `architecture-diagram` | `creative/architecture-diagram/SKILL.md` | 6967 | `2cecf78a9ebd0e56` | eligible_full_copy |
...
| `baoyu-comic` | `creative/baoyu-comic/SKILL.md` | 14621 | `39daa86a4c9737a5` | eligible_full_copy |
...
| `pixel-art` | `creative/pixel-art/SKILL.md` | 7581 | `01f351726675bb5e` | eligible_full_copy |
...
| `kanban-orchestrator` | `devops/kanban-orchestrator/SKILL.md` | 14105 | `c60c7fcfb64157d7` | eligible_full_copy |
| `kanban-worker` | `devops/kanban-worker/SKILL.md` | 10030 | `aef52e7513b68e0f` | eligible_full_copy |
| `webhook-subscriptions` | `devops/webhook-subscriptions/SKILL.md` | 6836 | `dfb4ddad9b7911db` | eligible_full_copy |
...
| `minecraft-modpack-server` | `gaming/minecraft-modpack-server/SKILL.md` | 6559 | `858f64c0e67efb29` | eligible_full_copy |
| `pokemon-player` | `gaming/pokemon-player/SKILL.md` | 8709 | `fe8da8e6dc5599ef` | eligible_full_copy |
...
| `spotify` | `media/spotify/SKILL.md` | 6319 | `84b4c86e75f08288` | eligible_full_copy |
| `youtube-content` | `media/youtube-content/SKILL.md` | 3384 | `03cba418b10c64a3` | eligible_full_copy |
| `evaluating-llms-harness` | `mlops/evaluation/lm-evaluation-harness/SKILL.md` | 12020 | `5426016d51e3b49e` | eligible_full_copy |
| `weights-and-biases` | `mlops/evaluation/weights-and-biases/SKILL.md` | 12395 | `7cabb8bcc0079737` | catalog_only |
| `huggingface-hub` | `mlops/huggingface-hub/SKILL.md` | 3674 | `10d5bdf26e08ce47` | eligible_full_copy |
| `llama-cpp` | `mlops/inference/llama-cpp/SKILL.md` | 8880 | `9c1ef45f6197fbc0` | eligible_full_copy |
| `obliteratus` | `mlops/inference/obliteratus/SKILL.md` | 15464 | `9fb394a0af2a9733` | eligible_full_copy |
| `serving-llms-vllm` | `mlops/inference/vllm/SKILL.md` | 9071 | `ab72192b7aee4e6d` | catalog_only |
...
| `godmode` | `red-teaming/godmode/SKILL.md` | 20059 | `5ab1757d1b638258` | catalog_only |
